    ...
    public void onMethodCall(final MethodCall call, final Result result) {
         ...
         */
            ...
            if (purchasesResult.getResponseCode() != BillingClient.BillingResponseCode.OK) {
                String[] errorData = DoobooUtils.getInstance().getBillingResponseData(purchasesResult.getResponseCode());
                result.error(call.method, errorData[0], errorData[1]);
                return;
            }

            if (purchasesResult.getPurchasesList() == null) {
                result.error(call.method, DoobooUtils.E_PURCHASE_EMPTY, "Purchase list is empty.");
                return;
            }
